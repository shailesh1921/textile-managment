...
export const Layout = ({ activeTab, setActiveTab, children }) => {
  ...
  const navigation = [
    ...
    { id: 'digital_twin', name: t('nav_digital_twin'), icon: Gauge, badge: 'LIVE' },
    { id: 'recipe_optimizer', name: t('nav_recipe_optimizer'), icon: FlaskConical },
    { id: 'ai_vision_qc', name: t('nav_ai_vision_qc'), icon: Eye },
    { id: 'whatsapp_gateway', name: t('nav_whatsapp_gateway'), icon: MessageSquare },
    { id: 'esg_sustainability', name: t('nav_esg_sustainability'), icon: Leaf },
